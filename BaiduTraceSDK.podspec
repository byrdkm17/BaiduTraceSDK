#
#  Be sure to run `pod spec lint BaiduTraceSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "BaiduTraceSDK"
  spec.version      = "3.0.7"
  spec.summary      = "百度鹰眼轨迹服务 SDK"
  ...
  spec.source       = { :git => "https://github.com/byrdkm17/BaiduTraceSDK.git", :tag => "#{spec.version}" }
